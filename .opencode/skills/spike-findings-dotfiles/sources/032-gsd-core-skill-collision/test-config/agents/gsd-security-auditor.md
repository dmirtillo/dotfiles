...
**Verification depth scales with `asvs_level`** (see @/Users/dmirtillo/projects/software/dotfiles/.planning/spikes/032-gsd-core-skill-collision/test-config/gsd-core/references/security-asvs-levels.md for full definitions):
