...
**If doesn't exist:** Create from template at `/Users/dmirtillo/projects/software/dotfiles/.planning/spikes/032-gsd-core-skill-collision/test-config/gsd-core/templates/retrospective.md`.
