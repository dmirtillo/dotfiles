...
- Usage: Reference from command with `@/Users/dmirtillo/projects/software/dotfiles/.planning/spikes/032-gsd-core-skill-collision/local-test/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /Users/dmirtillo/projects/software/dotfiles/.planning/spikes/032-gsd-core-skill-collision/local-test/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/dmirtillo/projects/software/dotfiles/.planning/spikes/032-gsd-core-skill-collision/local-test/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
