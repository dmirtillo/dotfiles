...
`@/Users/dmirtillo/projects/software/dotfiles/.planning/spikes/032-gsd-core-skill-collision/local-test/gsd-core/references/edge-probe.md`: `edge-probe` reaches the
