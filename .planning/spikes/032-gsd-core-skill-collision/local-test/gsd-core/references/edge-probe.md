...
`@/Users/dmirtillo/projects/software/dotfiles/.planning/spikes/032-gsd-core-skill-collision/local-test/gsd-core/references/domain-probes.md`: `domain-probes` covers the
