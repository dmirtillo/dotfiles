...
The keys live in `.claude/settings.json` (project) or `/Users/dmirtillo/projects/software/dotfiles/.planning/spikes/032-gsd-core-skill-collision/test-config/settings.json` (global) — **not** in `.planning/config.json`:
