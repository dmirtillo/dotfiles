...
<required_reading>
@/Users/dmirtillo/projects/software/dotfiles/.planning/spikes/032-gsd-core-skill-collision/test-config/gsd-core/references/ai-frameworks.md
@/Users/dmirtillo/projects/software/dotfiles/.planning/spikes/032-gsd-core-skill-collision/test-config/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/dmirtillo/projects/software/dotfiles/.planning/spikes/032-gsd-core-skill-collision/test-config/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/dmirtillo/projects/software/dotfiles/.planning/spikes/032-gsd-core-skill-collision/test-config/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/dmirtillo/projects/software/dotfiles/.planning/spikes/032-gsd-core-skill-collision/test-config/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/dmirtillo/projects/software/dotfiles/.planning/spikes/032-gsd-core-skill-collision/test-config/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/dmirtillo/projects/software/dotfiles/.planning/spikes/032-gsd-core-skill-collision/test-config/agents/gsd-eval-planner.md for instructions.
